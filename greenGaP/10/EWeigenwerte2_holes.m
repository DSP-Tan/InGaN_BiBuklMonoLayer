...
%break
%------
epsilonref=1.%1.5%1.2%0.65%2.4%0.55%1.8%0.95;%1.6%2.5%0.9%0.7;%2.5;%1.4;%1.4;%2.5;%1.4%3.6%1.6%0.95%1.4%0.8
h3=(H2-epsilonref*H);
disp('h3 angelegt')
clear H2;
clear H;
...
[EV,EW]=jdqr(A,275,'sr',OPTIONS);%eigs(A,15,'sr',OPTIONS);%eigstefanreal(H3,6,'sr',OPTIONS);
EW = diag(EW);
